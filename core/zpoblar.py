...
def poblar_bd(test_user_email=''):
    ...
    productos_data = [
        # Categoría "Suite" (6 habitaciones)
        {
            ...
            'descuento_oferta': 15,
            'imagen': 'productos/SuitePresidencial.png'
        },
        {
            'id': 2,
            'categoria': Categoria.objects.get(id=1),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 10,
            'imagen': 'productos/SuiteMatrimonial.png'
        },
        {
            'id': 3,
            'categoria': Categoria.objects.get(id=1),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
            'imagen': 'productos/SuiteEjecutiva.png'
        },
        {
            'id': 4,
            'categoria': Categoria.objects.get(id=1),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 5,
            'imagen': 'productos/SuiteFamiliar.png'
        },
        {
            'id': 5,
            'categoria': Categoria.objects.get(id=1),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 20,
            'imagen': 'productos/SuitePanoramica.png'
        },
        {
            'id': 6,
            'categoria': Categoria.objects.get(id=1),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 10,
            'imagen': 'productos/SuiteDeluxe.png'
        },
        ...
        # Categoría "Simple" (3 habitaciones)
        {
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
            'imagen': 'productos/SimpleEstandar.png'
        },
        {
            'id': 10,
            'categoria': Categoria.objects.get(id=2),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 20,
            'imagen': 'productos/SimpleSuperior.png'
        },
        {
            'id': 11,
            'categoria': Categoria.objects.get(id=2),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 10,
            'imagen': 'productos/SimpleDeluxe.png'
        },
        ...
        # Categoría "Doble" (3 habitaciones)
        {
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 5,
            'imagen': 'productos/DobleEstandar.png'
        },
        {
            'id': 14,
            'categoria': Categoria.objects.get(id=3),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 15,
            'imagen': 'productos/DobleSuperior.png'
        },
        {
            'id': 15,
            'categoria': Categoria.objects.get(id=3),
            ...
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
            'imagen': 'productos/DobleDeluxe.png'
        },
    ]
