...
def bodega(request):
    ...
    for registro in registros:
        ...
        item = {
            ...
            'estado': 'Vendido' if vendido else 'Disponible',
...
def obtener_info_producto(producto_id):
    ...
    agotado = '<span class="text-danger"> RESERVADO </span>'
    ...
    en_stock = f'Disponible: {formatear_numero(stock)} {"Habitacion" if stock == 1 else "Habitaciones"}'
